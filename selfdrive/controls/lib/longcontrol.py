...
def limit_accel_in_turns(v_ego, angle_steers, a_target, CP):
  ...
  It should avoid accelerating when losing the target in turns.
  """
...
class LongitudinalPlanner:
  ...
  def publish(self, classic_model, sm, pm, frogpilot_toggles):
    ...
    # If a lead is detected and its time-to-collision (TTC) falls below 1.0 second,
    # force shouldStop to be True.
