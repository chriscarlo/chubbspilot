...
class CarTuningConfig:
  ...
  comfy_decel: float  # Add this: Comfortable deceleration rate (m/s^2, positive value)
  stop_buffer: float  # Add this: Desired buffer distance at stop (metres)
