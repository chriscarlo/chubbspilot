...
class FrogPilotFollowing:
  def __init__(self, FrogPilotPlanner):
    ...
    self.speed_jerk = 0
    self.t_follow = 0
    self.personality_t_follow = 0  # baseline personality follow setting
  ...
  def update_follow_values(self, lead_distance, v_ego, v_lead, frogpilot_toggles):
    ...
    # Taper gracefully back to the personality setting when conditions stabilize
    smoothing_rate = 0.1  # Adjust this rate as needed
    self.t_follow = (1 - smoothing_rate) * self.t_follow + smoothing_rate * self.personality_t_follow