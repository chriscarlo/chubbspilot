...
QT_MOC_LITERAL(3, 40, 19) // "openSubParentToggle"

    },
    "FrogPilotVisualsPanel\0openParentToggle\0"
    "\0openSubParentToggle"
};
...
void FrogPilotVisualsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FrogPilotVisualsPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotVisualsPanel::openSubParentToggle)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void FrogPilotVisualsPanel::openSubParentToggle()
{
