...
def main():
    ...
    print("                 The service with the EARLIEST timestamp for this issue is the prime suspect for an invalid data cascade.")
    ...
    print("\nTimestamps indicate the *first* time an issue is detected by this script instance.")
    print("To find the ORIGIN of an 'INVALID_MSG' cascade, look for the service(s) that report 'INVALID_MSG'")
    print("with the EARLIEST timestamp(s). If multiple services show this simultaneously, they are all initial candidates.")
    print("Run this script BEFORE the issue occurs for best results, or as soon as it's suspected.")
